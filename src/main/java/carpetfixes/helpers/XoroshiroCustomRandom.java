...
public class XoroshiroCustomRandom extends java.util.Random implements Random {
    ...
    public static class RandomDeriver implements net.minecraft.util.math.random.RandomSplitter {
